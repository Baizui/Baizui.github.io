...
用RubyInstaller 安裝後，可以清晰地看到它的整个目录结构，并根据其目录结构来更改自己的文章和Jekyll [目录结构] [目录结构][http://wiki.jikexueyuan.com/project/jekyll/structure.html][http://wiki.jikexueyuan.com/project/jekyll/structure.html]
